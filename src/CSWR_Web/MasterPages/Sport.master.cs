...
namespace BP.CheatSheetWarRoom.UI
{
  public partial class SportMaster : System.Web.UI.MasterPage
  {
    ...
    private void DetermineIfByeWeekPage()
    {
      if (Globals.isPageInSitemapTree("bye-weeks"))
      {
        panLandingContainer.CssClass = "noAdContainer footballLanding";
        var frameMaster = (BP.CheatSheetWarRoom.UI.Web20Frame)this.Page.Master.Master;
        frameMaster.HideAds();
      }
      //else
      //{

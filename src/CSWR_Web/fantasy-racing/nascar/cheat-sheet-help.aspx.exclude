<%@ Page Language="C#" MasterPageFile="~/MasterPages/Sport.master" AutoEventWireup="true" 
  ...
  Title="Racing Cheat Sheet Help" 
  MetaDescription="This page explains all features available in our custom racing cheat sheet interface."
  CanonicalUrl="http://www.cheatsheetwarroom.com/fantasy-racing/nascar/cheat-sheet-help.aspx"
%>
  ...
  <div class="sheetHelpPage">
    ...
    <div class="intro">
      ...
      <p>
        ...
        <asp:Hyperlink runat="server" NavigateUrl="http://www.cheatsheetwarroom.com/community/register.aspx">register</asp:Hyperlink>.
      </p>
    ...
    <div class="subSection">
      ...
      <p>
        ...
        <asp:Hyperlink runat="server" NavigateUrl="http://www.cheatsheetwarroom.com/community/register.aspx">register for a free account</asp:Hyperlink>.

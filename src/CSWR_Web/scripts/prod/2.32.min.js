 ...
 *  jquery.ui.mouse.js
 */
!function(a){function f(a,b){if(!(a.originalEvent.touches.length>1)){a.preventDefault();var c=a.originalEvent.changedTouches[0],d=document.createEvent("MouseEvents");d.initMouseEvent(b,!0,!0,window,1,c.screenX,c.screenY,c.clientX,c.clientY,!1,!1,!1,!1,0,null),a.target.dispatchEvent(d)}}if(a.support.touch="ontouchend"in document,a.support.touch){var e,b=a.ui.mouse.prototype,c=b._mouseInit,d=b._mouseDestroy;b._touchStart=function(a){var b=this;!e&&b._mouseCapture(a.originalEvent.changedTouches[0])&&(e=!0,b._touchMoved=!1,f(a,"mouseover"),f(a,"mousemove"),f(a,"mousedown"))},b._touchMove=function(a){e&&(this._touchMoved=!0,f(a,"mousemove"))},b._touchEnd=function(a){e&&(f(a,"mouseup"),f(a,"mouseout"),this._touchMoved||f(a,"click"),e=!1)},b._mouseInit=function(){var b=this;b.element.bind({touchstart:a.proxy(b,"_touchStart"),touchmove:a.proxy(b,"_touchMove"),touchend:a.proxy(b,"_touchEnd")}),c.call(b)},b._mouseDestroy=function(){var b=this;b.element.unbind({touchstart:a.proxy(b,"_touchStart"),touchmove:a.proxy(b,"_touchMove"),touchend:a.proxy(b,"_touchEnd")}),d.call(b)}}}(jQuery);function EditNote(i,m,k,s,o,g,q,e,c){var h=document.getElementById(i);var l=document.getElementById(m);var j=document.getElementById(k);var r=document.getElementById(s);var n=document.getElementById(o);var d=document.getElementById(e);var p=document.getElementById(q);var f=document.getElementById(g);var b=document.getElementById(c);l.className="invisible";n.className="invisible";f.className="invisible";j.className="visible editNoteContainer";p.className="visible";d.className="visible";var a=htmlDecode(b.value);if(document.all){r.value=a}else{r.value=a}r.focus();r.select()}function CancelEdit(j,l,b,h,n,f,d,p){var i=document.getElementById(j);var k=document.getElementById(l);var a=document.getElementById(b);var g=document.getElementById(h);var e=document.getElementById(f);var c=document.getElementById(d);var o=document.getElementById(p);var m=document.getElementById(n);i.className="invisible";if(document.all){if(g.innerText==""){a.className="visible"}else{g.className="visible";k.className="visibleBlock viewNoteContainer";m.className="visible";e.className="visible"}}else{if(g.textContent==""){a.className="visible"}else{g.className="visible";k.className="visibleBlock viewNoteContainer";m.className="visible";e.className="visible"}}c.className="invisible";o.className="invisible"}function AddNote(a,c,e,b,d){$("#"+a).removeClass().addClass("invisible");$("#"+c).removeClass().addClass("editNoteContainer visible");$("#"+b).removeClass().addClass("visible");$("#"+d).removeClass().addClass("visible");$("#"+e).val("");$("#"+e).focus()}function DeleteNote(a,k,c,g,i,e,o,m,r){var j=document.getElementById(k);var b=document.getElementById(c);var f=document.getElementById(g);var h=document.getElementById(i);var d=document.getElementById(e);var n=document.getElementById(o);var l=document.getElementById(m);var q=document.getElementById(r);var p=window.confirm("Are you sure you want to delete this note?");if(p==true){if(document.all){f.innerText=""}else{f.textContent=""}q.value="";PageMethods.DeleteNote(a);b.className="visible";d.className="invisible";l.className="invisible";j.className="invisible"}else{return false}}function SaveNote(a,A,s,u,o,k,y,g,i,w,e,m,p){var z=document.getElementById(A);var r=document.getElementById(s);var t=document.getElementById(u);var n=document.getElementById(o);var j=document.getElementById(k);var f=document.getElementById(g);var x=document.getElementById(y);var h=document.getElementById(i);var v=document.getElementById(w);var d=document.getElementById(e);var l=document.getElementById(m);if(z.value==""){r.className="invisible";x.className="invisible";f.className="visible";h.className="invisible"}else{r.className="invisible";t.className="visibleBlock viewNoteContainer";n.className="visible";j.className="visible";x.className="invisible";h.className="invisible";v.className="visible"}d.value=htmlEncode(z.value);var c=z.value;var q;if(c.length>p){q=jQuery.trim(c).substring(0,p).split(" ").slice(0,-1).join(" ");l.className="visible";l.title=c}else{q=c;l.className="invisible"}$("#"+m).qtip({content:{text:l.title}});var b=htmlEncode(c);z.value=b;if(document.all){n.innerText=q;PageMethods.SaveNote(a,z.value)}else{n.textContent=q;PageMethods.SaveNote(a,z.value)}}function ChangeAndUpdate(b,a){var d=b.className!="tagActive";PageMethods.ChangeTag(a,d);b.className=d?"tagActive":"tagInactive";var c=a.split(/[\s-]+/);var e=c[c.length-1];switch(e){case"sleeper":b.title=d?"Click to indicate this player is not a Sleeper.":"Click to indicate this player is a Sleeper.";break;case"bust":b.title=d?"Click to indicate this player is not a Bust.":"Click to indicate this player is a Bust.";break;case"injured":b.title=d?"Click to indicate this player is not Injured.":"Click to indicate this player is Injured.";break}$("#"+b.id).qtip({content:{text:b.title}})}function htmlEncode(a){return $("<div/>").text(a).html()}function htmlDecode(a){return $("<div/>").html(a).text()};jQuery.easing.jswing=jQuery.easing.swing;jQuery.extend(jQuery.easing,{def:"easeOutQuad",swing:function(h,g,a,e,f){return jQuery.easing[jQuery.easing.def](h,g,a,e,f)},easeInQuad:function(h,g,a,e,f){return e*(g/=f)*g+a},easeOutQuad:function(h,g,a,e,f){return -e*(g/=f)*(g-2)+a},easeInOutQuad:function(h,g,a,e,f){if((g/=f/2)<1){return e/2*g*g+a}return -e/2*((--g)*(g-2)-1)+a},easeInCubic:function(h,g,a,e,f){return e*(g/=f)*g*g+a},easeOutCubic:function(h,g,a,e,f){return e*((g=g/f-1)*g*g+1)+a},easeInOutCubic:function(h,g,a,e,f){if((g/=f/2)<1){return e/2*g*g*g+a}return e/2*((g-=2)*g*g+2)+a},easeInQuart:function(h,g,a,e,f){return e*(g/=f)*g*g*g+a},easeOutQuart:function(h,g,a,e,f){return -e*((g=g/f-1)*g*g*g-1)+a},easeInOutQuart:function(h,g,a,e,f){if((g/=f/2)<1){return e/2*g*g*g*g+a}return -e/2*((g-=2)*g*g*g-2)+a},easeInQuint:function(h,g,a,e,f){return e*(g/=f)*g*g*g*g+a},easeOutQuint:function(h,g,a,e,f){return e*((g=g/f-1)*g*g*g*g+1)+a},easeInOutQuint:function(h,g,a,e,f){if((g/=f/2)<1){return e/2*g*g*g*g*g+a}return e/2*((g-=2)*g*g*g*g+2)+a},easeInSine:function(h,g,a,e,f){return -e*Math.cos(g/f*(Math.PI/2))+e+a},easeOutSine:function(h,g,a,e,f){return e*Math.sin(g/f*(Math.PI/2))+a},easeInOutSine:function(h,g,a,e,f){return -e/2*(Math.cos(Math.PI*g/f)-1)+a},easeInExpo:function(h,g,a,e,f){return(g==0)?a:e*Math.pow(2,10*(g/f-1))+a},easeOutExpo:function(h,g,a,e,f){return(g==f)?a+e:e*(-Math.pow(2,-10*g/f)+1)+a},easeInOutExpo:function(h,g,a,e,f){if(g==0){return a}if(g==f){return a+e}if((g/=f/2)<1){return e/2*Math.pow(2,10*(g-1))+a}return e/2*(-Math.pow(2,-10*--g)+2)+a},easeInCirc:function(h,g,a,e,f){return -e*(Math.sqrt(1-(g/=f)*g)-1)+a},easeOutCirc:function(h,g,a,e,f){return e*Math.sqrt(1-(g=g/f-1)*g)+a},easeInOutCirc:function(h,g,a,e,f){if((g/=f/2)<1){return -e/2*(Math.sqrt(1-g*g)-1)+a}return e/2*(Math.sqrt(1-(g-=2)*g)+1)+a},easeInElastic:function(l,k,f,g,h){var j=1.70158;var i=0;var e=g;if(k==0){return f}if((k/=h)==1){return f+g}if(!i){i=h*0.3}if(e<Math.abs(g)){e=g;var j=i/4}else{var j=i/(2*Math.PI)*Math.asin(g/e)}return -(e*Math.pow(2,10*(k-=1))*Math.sin((k*h-j)*(2*Math.PI)/i))+f},easeOutElastic:function(l,k,f,g,h){var j=1.70158;var i=0;var e=g;if(k==0){return f}if((k/=h)==1){return f+g}if(!i){i=h*0.3}if(e<Math.abs(g)){e=g;var j=i/4}else{var j=i/(2*Math.PI)*Math.asin(g/e)}return e*Math.pow(2,-10*k)*Math.sin((k*h-j)*(2*Math.PI)/i)+g+f},easeInOutElastic:function(l,k,f,g,h){var j=1.70158;var i=0;var e=g;if(k==0){return f}if((k/=h/2)==2){return f+g}if(!i){i=h*(0.3*1.5)}if(e<Math.abs(g)){e=g;var j=i/4}else{var j=i/(2*Math.PI)*Math.asin(g/e)}if(k<1){return -0.5*(e*Math.pow(2,10*(k-=1))*Math.sin((k*h-j)*(2*Math.PI)/i))+f}return e*Math.pow(2,-10*(k-=1))*Math.sin((k*h-j)*(2*Math.PI)/i)*0.5+g+f},easeInBack:function(i,h,a,e,f,g){if(g==undefined){g=1.70158}return e*(h/=f)*h*((g+1)*h-g)+a},easeOutBack:function(i,h,a,e,f,g){if(g==undefined){g=1.70158}return e*((h=h/f-1)*h*((g+1)*h+g)+1)+a},easeInOutBack:function(i,h,a,e,f,g){if(g==undefined){g=1.70158}if((h/=f/2)<1){return e/2*(h*h*(((g*=(1.525))+1)*h-g))+a}return e/2*((h-=2)*h*(((g*=(1.525))+1)*h+g)+2)+a},easeInBounce:function(h,g,a,e,f){return e-jQuery.easing.easeOutBounce(h,f-g,0,e,f)+a},easeOutBounce:function(h,g,a,e,f){if((g/=f)<(1/2.75)){return e*(7.5625*g*g)+a}else{if(g<(2/2.75)){return e*(7.5625*(g-=(1.5/2.75))*g+0.75)+a}else{if(g<(2.5/2.75)){return e*(7.5625*(g-=(2.25/2.75))*g+0.9375)+a}else{return e*(7.5625*(g-=(2.625/2.75))*g+0.984375)+a}}}},easeInOutBounce:function(h,g,a,e,f){if(g<f/2){return jQuery.easing.easeInBounce(h,g*2,0,e,f)*0.5+a}return jQuery.easing.easeOutBounce(h,g*2-f,0,e,f)*0.5+e*0.5+a}});(function(a){var d={init:function(f){var e={easing:"swing",duration:700,margins:false,setOnClick:false,activeObj:".active",autoUpdate:false,updateTime:100,enableHover:true};var f=a.extend({},e,f);return this.each(function(){var A=f.easing;var G=f.duration;var D=f.margins;var I=f.setOnClick;var j=f.activeObj;var t=f.autoUpdate;var B=f.updateTime;var n=f.enableHover;var z=a(this);var F=z.children();var q=z.children(j);if(q.length==0){q=F.eq(0)}z.data({easing:A,duration:G,margins:D,setOnClick:I,active:q,enableHover:n,isAnim:false});z.addClass("lavalamp").css({position:"relative"});var J=a('<div class="lavalamp-object" />').prependTo(z).css({position:"absolute"});F.addClass("lavalamp-item").css({zIndex:5,position:"relative"});var C=q.outerWidth(D);var x=q.outerHeight(D);var L=q.position().top;var k=q.position().left;var K=q.css("marginTop");var r=q.css("marginLeft");if(!D){r=parseInt(r);K=parseInt(K);k=k+r;L=L+K}J.css({width:C,height:x,top:L,left:k});var H=false;b=function(){var g=a(this);H=true;z.lavalamp("anim",g)};c=function(){var g=z.data("active");H=false;z.lavalamp("anim",g)};if(n){z.on("mouseenter",".lavalamp-item",b);z.on("mouseleave",".lavalamp-item",c)}if(I){F.click(function(){q=a(this);z.data("active",q).lavalamp("update")})}if(t){setInterval(function(){var g=z.data("isAnim");if(H==false&&g==false){z.lavalamp("update")}},B)}})},destroy:function(){return this.each(function(){var g=a(this);var e=g.children(".lavalamp-item");var f=g.data("enableHover");if(f){g.off("mouseenter",".lavalamp-item",b);g.off("mouseleave",".lavalamp-item",c)}g.removeClass("lavalamp");e.removeClass("lavalamp-item");g.children(".lavalamp-object").remove();g.removeData()})},update:function(){return this.each(function(){var h=a(this);var f=h.children(":not(.lavalamp-object)");var g=h.data("active");var e=h.children(".lavalamp-object");f.addClass("lavalamp-item").css({zIndex:5,position:"relative"});h.lavalamp("anim",g)})},anim:function(j){var y=this;var q=y.data("duration");var w=y.data("easing");var m=y.data("margins");var x=y.children(".lavalamp-object");var v=j.outerWidth(m);var z=j.outerHeight(m);var g=j.position().top;var k=j.position().left;var p=j.css("marginTop");var h=j.css("marginLeft");if(!m){h=parseInt(h);p=parseInt(p);k=k+h;g=g+p}y.data("isAnim",true);x.stop(true,false).animate({width:v,height:z,top:g,left:k},q,w,function(){y.data("isAnim",false)})}};a.fn.lavalamp=function(e){if(d[e]){return d[e].apply(this,Array.prototype.slice.call(arguments,1))}else{if(typeof e==="object"||!e){return d.init.apply(this,arguments)}else{a.error("Method "+e+" does not exist on jQuery.lavalamp")}}};var b,c})(jQuery);(function(a){a.fn.CevherLink=function(p){var k=a(this);c(k);var j={icon_src:"[x]",minimize:"[-]",maximize:"[+]",href:"none",text:"",border:"1px black solid",corner:"0px",text_color:"black",time:false,text_position:"top",text_font:"Arial",text_weight:"normal",background:"#fff",size:"14px",position:"bottom-rigth",popup_width:"300",popup_height:"55",language:"en_US",timer:10,pause:"[ii]",start:"[>]",middle_html:"",cookie_day:"1"};var q=a.extend(j,p);if(q.popup_width<300){q.popup_width=300}if(q.popup_height<55){q.popup_height=55}k.css({position:"fixed","z-index":"999999999",width:q.popup_width,"min-height":q.popup_height,border:q.border,background:q.background,"border-radius":q.corner,"-moz-border-radius":q.corner,"azimuth-webkit-border-radius":q.corner,"-khtml-border-radius":q.corner,overflow:"hidden",visibility:"hidden"});if(q.position!="bottom-right"&&q.position!="top-right"&&q.position!="bottom-left"&&q.position!="top-left"){q.position="bottom-right"}var m="<iframe id='cevherlink' src=\"http://www.facebook.com/plugins/likebox.php?locale="+q.language+"&href="+q.href+'&amp;width=292&amp;colorscheme=light&amp;show_faces=false&amp;border_color&amp;stream=false&amp;header=false&amp;height=88" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:292px; min-height:62px; max-height:90px;backgorund:#ccc;" allowTransparency="true"></iframe>';var t="<div id='cevher_text'>"+q.text+"</div>";var i="<div id='cevher_close'></div>";var o="<div id='cevher_minimize'></div>";var n="<div id='cevher_maximize'></div>";var r="<div id='cevher_pause' check='1' style='position:absolute;bottom:5px;right:5px;cursor:pointer;color:#555'></div>";var s="<div id='cevher_start' check='0' style='position:absolute;bottom:5px;right:5px;display:none;cursor:pointer;color:#555'></div>";var l="<div id='cevher_middle'>"+q.middle_html+"</div>";var h="<div id='cevher_link_timer' style='position:absolute;bottom:3px;right:30px;'>"+q.timer+"</div>";k.html(t);k.find("#cevher_text").css({"max-width":q.popup_width,"max-height":q.popup_height,color:q.text_color,margin:"2px auto","font-size":q.size,"font-family":q.text_font,"font-weight":q.text_weight,padding:"4px 30px 4px 4px"});if(q.text_position=="bottom"){a(m+l+i+o+n).insertBefore("#cevher_text");k.append(h+s+r)}else{k.append(l+m+h+s+r+i+o+n)}k.find("#cevher_close").css({position:"absolute",right:"10px",top:"5px",cursor:"pointer"});k.find("#cevher_minimize").css({position:"absolute",right:"30px",top:"5px",cursor:"pointer","z-index":"9999"});k.find("#cevher_maximize").css({position:"absolute",right:"10px",top:"30px",cursor:"pointer",display:"none","z-index":"99999"});a("#cevherlink,#cevher_middle").load(function(){var u=q.timer;if(!u||u==0||f(u)==0){oley=0}else{oley=1;var z=setInterval(B,1000)}if(oley==0){k.find("#cevher_pause,#cevher_start,#cevher_link_timer").css({display:"none"})}var w=k.outerWidth();var v=k.outerHeight();d(q.icon_src,"cevher_close",j.icon_src,k);d(q.minimize,"cevher_minimize",j.minimize,k);d(q.maximize,"cevher_maximize",j.maximize,k);d(q.pause,"cevher_pause",j.pause,k);d(q.start,"cevher_start",j.start,k);k.css({visibility:"visible"});var C=-k.outerWidth();var A=q.position;var D=A.substring(A.indexOf("-")+1,A.length);var E=A.substring(0,A.indexOf("-"));if(E=="bottom"){k.css({bottom:"20px"})}if(E=="top"){k.css({top:"20px"})}if(D=="right"){k.css({right:C}).animate({right:"50px"},500).animate({right:"10px"},500).animate({right:"30px"},500)}if(D=="left"){k.css({left:C}).animate({left:"50px"},500).animate({left:"10px"},500).animate({left:"30px"},500)}k.find("#cevher_close").live({click:function(){username=Math.floor(Math.random()*11);if(username!=null&&username!=""){g("username",username,q.cookie_day)}if(D=="right"){k.animate({right:"50px"},500).animate({right:C},500,function(){k.remove()})}if(D=="left"){k.animate({left:"50px"},500).animate({left:C},500,function(){k.remove()})}}});k.find("#cevher_minimize").live({click:function(){if(oley==1){clearInterval(z)}k.find("#cevher_text,#cevher_middle,#cevher_link_timer,#cevherlink,#cevher_minimize,#cevher_pause,#cevher_start").animate({opacity:"0"},{queue:true,duration:500});k.animate({height:"60px",width:"35px"},500,function(){k.find("#cevher_maximize").css({display:"block"});k.find("#cevher_text,#cevher_middle,#cevher_link_timer,#cevherlink,#cevher_minimize,#cevher_pause,#cevher_start").css({display:"none"})})}});k.find("#cevher_maximize").live({click:function(){k.find("#cevher_text,#cevher_middle,#cevherlink,#cevher_minimize").css({display:"block"}).animate({opacity:"1"},{queue:true,duration:500});k.animate({height:v+"px",width:w+"px"},500,function(){if(oley==1){if(k.find("#cevher_pause").attr("check")=="1"){z=setInterval(B,1000);k.find("#cevher_pause,#cevher_link_timer").css({display:"block"})}else{k.find("#cevher_start,#cevher_link_timer").css({display:"block"})}k.find("#cevher_pause,#cevher_start,#cevher_link_timer,").css({opacity:"1"})}k.find("#cevher_maximize").css({display:"none"})})}});function B(x){if(oley==1){u--;k.find("#cevher_link_timer").text(u);if(u==0){clearInterval(z);if(D=="right"){k.animate({right:"50px"},500).animate({right:C},500,function(){k.remove()})}if(D=="left"){k.animate({left:"50px"},500).animate({left:C},500,function(){k.remove()})}}}}k.find("#cevher_pause").live("click",function(){clearInterval(z);k.find("#cevher_pause").css({display:"none"}).attr({check:"0"});k.find("#cevher_start").css({display:"block"}).attr({check:"1"})});k.find("#cevher_start").live("click",function(){z=setInterval(B,1000);k.find("#cevher_pause").css({display:"block"}).attr({check:"1"});k.find("#cevher_start").css({display:"none"}).attr({check:"0"})})})};function e(j){var k,l,m,h=document.cookie.split(";");for(k=0;k<h.length;k++){l=h[k].substr(0,h[k].indexOf("="));m=h[k].substr(h[k].indexOf("=")+1);l=l.replace(/^\s+|\s+$/g,"");if(l==j){return unescape(m)}}}function b(i,h){return new Date(i.getTime()+h*24*60*60*1000)}function g(h,l,k){var j=b(new Date(),k);var i=escape(l)+((k==null)?"":"; expires="+j.toUTCString());document.cookie=h+"="+i}function c(h){var i=e("username");if(i!=null&&i!=""){h.remove()}return false}function f(h){return(h.toString().search(/^-?[0-9]+$/)==0)}function d(l,j,i,h){var k=new Image();k.onload=function(){var m="<img src='"+l+"' width='16' height='16'/>";a("#"+j).html(m)};k.onerror=function(){h.find("#"+j).html(i)};k.src=l}})(jQuery);(function(a){a.fn.facebookTrafficPop=function(e){var b={wait:0,delay:0,timeout:25,lang:"en",opacity:"25",title:"Your Popup Title",message:"Your popup / call to action message!",closeable:false,advancedClose:false,onClick:"fbtp-open",closeCookie:"false",like_button:true,url:"https://www.cheatsheetwarroom.com/fantasy-football/nfl/create/custom-sheet.aspx",showfaces:true,layout:"standard",colorscheme:"light",app_id:"265113826838564",share_button:true,share_url:"https://www.cheatsheetwarroom.com/fantasy-football/nfl/create/custom-sheet.aspx",share_label:"Share",share_title:"",share_message:""};var e=a.extend(b,e);var d=false;b.delay=(b.delay*1000);b.opacity="0."+b.opacity;var f={orwait:{en:"Or wait",fr:"Ou attendre",de:"Order warten",it:"O attendere",es:"O esperar"},seconds:{en:"Seconds",fr:"Secondes",de:"Sekunden",it:"Secondi",es:"Segundos"},closeable:{en:"Close",fr:"Fermer",de:"N&auml;he",it:"Chiudi",es:"Cerrar"}};fbtp_createCookie=function(j,k,h){if(h){var g=new Date();g.setTime(g.getTime()+(h*24*60*60*1000));var i="; expires="+g.toGMTString()}else{var i=""}document.cookie=j+"="+k+i+"; path=/"};fbtp_readCookie=function(k){var l=k+"=";var h=document.cookie.split(";");for(var j=0;j<h.length;j++){var g=h[j];while(g.charAt(0)==" "){g=g.substring(1,g.length)}if(g.indexOf(l)==0){return g.substring(l.length,g.length)}}return null};fbtp_createWait=function(j,k,i){if(i){var g=new Date();g.setTime(g.getTime()+(i*60*1000));var h="; expires="+g.toGMTString()}else{var h=""}document.cookie=j+"="+k+h+"; path=/"};fbtp_share=function(){console.log("Button Hit");FB.init({appId:b.app_id,status:true,cookie:true});FB.ui({method:"feed",link:b.share_url,name:b.share_title,description:b.share_message,show_error:true},function(g){if(g){fbtp_dump(true)}})};fbtp_recenter=function(){var g=a("#fblikepop");var k=document.documentElement.clientWidth;var j=document.documentElement.clientHeight;var h=g.outerHeight(true);var i=g.width();g.css({top:((j-h)/2)+"px",left:k/2-i/2});a("#fblikebg").css({height:j})};a(window).resize(function(){fbtp_recenter()});function c(h){var g=document.createElement("div");g.innerHTML=h;return g.childNodes.length===0?"":g.childNodes[0].nodeValue}fbtp_dump=function(g){if(g==true){fbtp_createCookie("fblikepop","true",30)}a("#fblikebg").fadeOut("slow");a("#fblikepop").fadeOut("slow");a("#fblikepop #counter").countdown("destroy")};fbtp_display=function(){if(a(window).width()>700){fbtp_recenter();a("#fblikebg").css({opacity:b.opacity});a("#fblikebg").fadeIn("slow");a("#fblikepop").fadeIn("slow");if(b.timeout=="0"){a("#counter-display").hide()}else{a("#fblikepop #counter").countdown({until:"+"+b.timeout+"s",format:"S",compact:true,description:"",onExpiry:fbtp_dump})}if(b.wait!=0){fbtp_createWait("fblikepopwait","true",b.wait)}FB.XFBML.parse();if(b.advancedClose==true){a(document).keyup(function(g){if(g.keyCode==27){fbtp_dump(false)}});a("body").click(function(){fbtp_dump(false)});a("#fblikepop").click(function(g){g.stopPropagation()})}}setTimeout(fbtp_recenter,300)};setTimeout(function(){getPopHTML=function(){var k="";var j="";if(b.url=="current"){b.url=window.location}if(b.share_button==true){k='<div class="fbtp-social-button share '+b.layout+'"><a href="#" class="fbtp-share '+b.colorscheme+'" onClick="fbtp_share();"><span>'+b.share_label+"</span></a></div>"}if(b.like_button==true){j='<div class="fbtp-social-button like"><fb:like id="fbtplike" href="'+b.url+'" show_faces="'+b.showfaces+'" width="300" layout="'+b.layout+'" colorscheme="'+b.colorscheme+'"></fb:like>'}var l='<div id="fblikebg"></div><div id="fblikepop"><div id="popup_head"><div id="closeable"></div><h1>'+b.title+'</h1></div><div id="popupMessage">'+c(b.message)+'</div><div id="buttonArea"><div id="actionHolder">'+k+j+'</div><div id="counter-display">'+f.orwait[b.lang]+' <span id="counter"> </span>  '+f.seconds[b.lang]+'.<br /><a id="fbtplink" href="http://goo.gl/LKCTz" title="Facebook Traffic Pop" target="_blank">Powered By FBTP</a></div><div style="clear:both"></div></div></div>';return l};var h=getPopHTML();a(document.body).append(h);var g=fbtp_readCookie("fblikepop");var i=fbtp_readCookie("fblikepopwait");if(g!="true"&&i!="true"){if(b.closeable==true){a("#closeable").html('<a id="#fbflush" class="fbflush" onClick="fbtp_dump('+b.closeCookie+');" href="#_">'+f.closeable[b.lang]+" x</a>")}fbtp_display()}},b.delay);a("."+b.onClick).live("click",function(g){g.preventDefault();g.stopImmediatePropagation();fbtp_display()});FB.Event.subscribe("edge.create",function(g,i){if(typeof i!="undefined"){var h=jQuery(i).attr("id");if(h=="fbtplike"){fbtp_dump(true)}}else{fbtp_dump(true)}})}})(jQuery);(function(a){function b(){this.regional=[];this.regional[""]={labels:["Years","Months","Weeks","Days","Hours","Minutes","Seconds"],labels1:["Year","Month","Week","Day","Hour","Minute","Second"],compactLabels:["y","m","w","d"],whichLabels:null,timeSeparator:":",isRTL:false};this._defaults={until:null,since:null,timezone:null,serverSync:null,format:"dHMS",layout:"",compact:false,significant:0,description:"",expiryUrl:"",expiryText:"",alwaysExpire:false,onExpiry:null,onTick:null,tickInterval:1};a.extend(this._defaults,this.regional[""]);this._serverSyncs=[]}var i="countdown";var k=0;var g=1;var j=2;var c=3;var e=4;var f=5;var h=6;a.extend(b.prototype,{markerClassName:"hasCountdown",_timer:setInterval(function(){a.countdown._updateTargets()},980),_timerTargets:[],setDefaults:function(l){this._resetExtraLabels(this._defaults,l);d(this._defaults,l||{})},UTCDate:function(l,m,n,p,q,r,s,t){if(typeof m=="object"&&m.constructor==Date){t=m.getMilliseconds();s=m.getSeconds();r=m.getMinutes();q=m.getHours();p=m.getDate();n=m.getMonth();m=m.getFullYear()}var o=new Date();o.setUTCFullYear(m);o.setUTCDate(1);o.setUTCMonth(n||0);o.setUTCDate(p||1);o.setUTCHours(q||0);o.setUTCMinutes((r||0)-(Math.abs(l)<30?l*60:l));o.setUTCSeconds(s||0);o.setUTCMilliseconds(t||0);return o},periodsToSeconds:function(l){return l[0]*31557600+l[1]*2629800+l[2]*604800+l[3]*86400+l[4]*3600+l[5]*60+l[6]},_settingsCountdown:function(l,m){if(!m){return a.countdown._defaults}var n=a.data(l,i);return(m=="all"?n.options:n.options[m])},_attachCountdown:function(l,m){var n=a(l);if(n.hasClass(this.markerClassName)){return}n.addClass(this.markerClassName);var o={options:a.extend({},m),_periods:[0,0,0,0,0,0,0]};a.data(l,i,o);this._changeCountdown(l)},_addTarget:function(l){if(!this._hasTarget(l)){this._timerTargets.push(l)}},_hasTarget:function(l){return(a.inArray(l,this._timerTargets)>-1)},_removeTarget:function(l){this._timerTargets=a.map(this._timerTargets,function(m){return(m==l?null:m)})},_updateTargets:function(){for(var l=this._timerTargets.length-1;l>=0;l--){this._updateCountdown(this._timerTargets[l])}},_updateCountdown:function(l,m){var n=a(l);m=m||a.data(l,i);if(!m){return}n.html(this._generateHTML(m));n[(this._get(m,"isRTL")?"add":"remove")+"Class"]("countdown_rtl");var o=this._get(m,"onTick");if(o){var p=m._hold!="lap"?m._periods:this._calculatePeriods(m,m._show,this._get(m,"significant"),new Date());var q=this._get(m,"tickInterval");if(q==1||this.periodsToSeconds(p)%q==0){o.apply(l,[p])}}var r=m._hold!="pause"&&(m._since?m._now.getTime()<m._since.getTime():m._now.getTime()>=m._until.getTime());if(r&&!m._expiring){m._expiring=true;if(this._hasTarget(l)||this._get(m,"alwaysExpire")){this._removeTarget(l);var s=this._get(m,"onExpiry");if(s){s.apply(l,[])}var t=this._get(m,"expiryText");if(t){var u=this._get(m,"layout");m.options.layout=t;this._updateCountdown(l,m);m.options.layout=u}var v=this._get(m,"expiryUrl");if(v){window.location=v}}m._expiring=false}else{if(m._hold=="pause"){this._removeTarget(l)}}a.data(l,i,m)},_changeCountdown:function(l,m,n){m=m||{};if(typeof m=="string"){var o=m;m={};m[o]=n}var p=a.data(l,i);if(p){this._resetExtraLabels(p.options,m);d(p.options,m);this._adjustSettings(l,p);a.data(l,i,p);var q=new Date();if((p._since&&p._since<q)||(p._until&&p._until>q)){this._addTarget(l)}this._updateCountdown(l,p)}},_resetExtraLabels:function(l,m){var o=false;for(var p in m){if(p!="whichLabels"&&p.match(/[Ll]abels/)){o=true;break}}if(o){for(var p in l){if(p.match(/[Ll]abels[0-9]/)){l[p]=null}}}},_adjustSettings:function(l,m){var n;var o=this._get(m,"serverSync");var p=0;var q=null;for(var t=0;t<this._serverSyncs.length;t++){if(this._serverSyncs[t][0]==o){q=this._serverSyncs[t][1];break}}if(q!=null){p=(o?q:0);n=new Date()}else{var r=(o?o.apply(l,[]):null);n=new Date();p=(r?n.getTime()-r.getTime():0);this._serverSyncs.push([o,p])}var s=this._get(m,"timezone");s=(s==null?-n.getTimezoneOffset():s);m._since=this._get(m,"since");if(m._since!=null){m._since=this.UTCDate(s,this._determineTime(m._since,null));if(m._since&&p){m._since.setMilliseconds(m._since.getMilliseconds()+p)}}m._until=this.UTCDate(s,this._determineTime(this._get(m,"until"),n));if(p){m._until.setMilliseconds(m._until.getMilliseconds()+p)}m._show=this._determineShow(m)},_destroyCountdown:function(l){var m=a(l);if(!m.hasClass(this.markerClassName)){return}this._removeTarget(l);m.removeClass(this.markerClassName).empty();a.removeData(l,i)},_pauseCountdown:function(l){this._hold(l,"pause")},_lapCountdown:function(l){this._hold(l,"lap")},_resumeCountdown:function(l){this._hold(l,null)},_hold:function(l,m){var n=a.data(l,i);if(n){if(n._hold=="pause"&&!m){n._periods=n._savePeriods;var o=(n._since?"-":"+");n[n._since?"_since":"_until"]=this._determineTime(o+n._periods[0]+"y"+o+n._periods[1]+"o"+o+n._periods[2]+"w"+o+n._periods[3]+"d"+o+n._periods[4]+"h"+o+n._periods[5]+"m"+o+n._periods[6]+"s");this._addTarget(l)}n._hold=m;n._savePeriods=(m=="pause"?n._periods:null);a.data(l,i,n);this._updateCountdown(l,n)}},_getTimesCountdown:function(l){var m=a.data(l,i);return(!m?null:(!m._hold?m._periods:this._calculatePeriods(m,m._show,this._get(m,"significant"),new Date())))},_get:function(l,m){return(l.options[m]!=null?l.options[m]:a.countdown._defaults[m])},_determineTime:function(p,q){var r=function(l){var m=new Date();m.setTime(m.getTime()+l*1000);return m};var s=function(l){l=l.toLowerCase();var m=new Date();var n=m.getFullYear();var o=m.getMonth();var u=m.getDate();var v=m.getHours();var w=m.getMinutes();var x=m.getSeconds();var y=/([+-]?[0-9]+)\s*(s|m|h|d|w|o|y)?/g;var z=y.exec(l);while(z){switch(z[2]||"s"){case"s":x+=parseInt(z[1],10);break;case"m":w+=parseInt(z[1],10);break;case"h":v+=parseInt(z[1],10);break;case"d":u+=parseInt(z[1],10);break;case"w":u+=parseInt(z[1],10)*7;break;case"o":o+=parseInt(z[1],10);u=Math.min(u,a.countdown._getDaysInMonth(n,o));break;case"y":n+=parseInt(z[1],10);u=Math.min(u,a.countdown._getDaysInMonth(n,o));break}z=y.exec(l)}return new Date(n,o,u,v,w,x,0)};var t=(p==null?q:(typeof p=="string"?s(p):(typeof p=="number"?r(p):p)));if(t){t.setMilliseconds(0)}return t},_getDaysInMonth:function(l,m){return 32-new Date(l,m,32).getDate()},_normalLabels:function(l){return l},_generateHTML:function(s){var t=this._get(s,"significant");s._periods=(s._hold?s._periods:this._calculatePeriods(s,s._show,t,new Date()));var u=false;var v=0;var w=t;var x=a.extend({},s._show);for(var y=k;y<=h;y++){u|=(s._show[y]=="?"&&s._periods[y]>0);x[y]=(s._show[y]=="?"&&!u?null:s._show[y]);v+=(x[y]?1:0);w-=(s._periods[y]>0?1:0)}var z=[false,false,false,false,false,false,false];for(var y=h;y>=k;y--){if(s._show[y]){if(s._periods[y]){z[y]=true}else{z[y]=w>0;w--}}}var A=this._get(s,"compact");var B=this._get(s,"layout");var C=(A?this._get(s,"compactLabels"):this._get(s,"labels"));var D=this._get(s,"whichLabels")||this._normalLabels;var E=this._get(s,"timeSeparator");var F=this._get(s,"description")||"";var G=function(l){var m=a.countdown._get(s,"compactLabels"+D(s._periods[l]));return(x[l]?s._periods[l]+(m?m[l]:C[l])+" ":"")};var H=function(l){var m=a.countdown._get(s,"labels"+D(s._periods[l]));return((!t&&x[l])||(t&&z[l])?'<span class="countdown_section"><span class="countdown_amount">'+s._periods[l]+"</span><br/>"+(m?m[l]:C[l])+"</span>":"")};return(B?this._buildLayout(s,x,B,A,t,z):((A?'<span class="countdown_row countdown_amount'+(s._hold?" countdown_holding":"")+'">'+G(k)+G(g)+G(j)+G(c)+(x[e]?this._minDigits(s._periods[e],2):"")+(x[f]?(x[e]?E:"")+this._minDigits(s._periods[f],2):"")+(x[h]?(x[e]||x[f]?E:"")+this._minDigits(s._periods[h],2):""):'<span class="countdown_row countdown_show'+(t||v)+(s._hold?" countdown_holding":"")+'">'+H(k)+H(g)+H(j)+H(c)+H(e)+H(f)+H(h))+"</span>"+(F?'<span class="countdown_row countdown_descr">'+F+"</span>":"")))},_buildLayout:function(n,s,t,u,v,w){var y=this._get(n,(u?"compactLabels":"labels"));var z=this._get(n,"whichLabels")||this._normalLabels;var A=function(l){return(a.countdown._get(n,(u?"compactLabels":"labels")+z(n._periods[l]))||y)[l]};var B=function(l,m){return Math.floor(l/m)%10};var C={desc:this._get(n,"description"),sep:this._get(n,"timeSeparator"),yl:A(k),yn:n._periods[k],ynn:this._minDigits(n._periods[k],2),ynnn:this._minDigits(n._periods[k],3),y1:B(n._periods[k],1),y10:B(n._periods[k],10),y100:B(n._periods[k],100),y1000:B(n._periods[k],1000),ol:A(g),on:n._periods[g],onn:this._minDigits(n._periods[g],2),onnn:this._minDigits(n._periods[g],3),o1:B(n._periods[g],1),o10:B(n._periods[g],10),o100:B(n._periods[g],100),o1000:B(n._periods[g],1000),wl:A(j),wn:n._periods[j],wnn:this._minDigits(n._periods[j],2),wnnn:this._minDigits(n._periods[j],3),w1:B(n._periods[j],1),w10:B(n._periods[j],10),w100:B(n._periods[j],100),w1000:B(n._periods[j],1000),dl:A(c),dn:n._periods[c],dnn:this._minDigits(n._periods[c],2),dnnn:this._minDigits(n._periods[c],3),d1:B(n._periods[c],1),d10:B(n._periods[c],10),d100:B(n._periods[c],100),d1000:B(n._periods[c],1000),hl:A(e),hn:n._periods[e],hnn:this._minDigits(n._periods[e],2),hnnn:this._minDigits(n._periods[e],3),h1:B(n._periods[e],1),h10:B(n._periods[e],10),h100:B(n._periods[e],100),h1000:B(n._periods[e],1000),ml:A(f),mn:n._periods[f],mnn:this._minDigits(n._periods[f],2),mnnn:this._minDigits(n._periods[f],3),m1:B(n._periods[f],1),m10:B(n._periods[f],10),m100:B(n._periods[f],100),m1000:B(n._periods[f],1000),sl:A(h),sn:n._periods[h],snn:this._minDigits(n._periods[h],2),snnn:this._minDigits(n._periods[h],3),s1:B(n._periods[h],1),s10:B(n._periods[h],10),s100:B(n._periods[h],100),s1000:B(n._periods[h],1000)};var D=t;for(var x=k;x<=h;x++){var E="yowdhms".charAt(x);var F=new RegExp("\\{"+E+"<\\}(.*)\\{"+E+">\\}","g");D=D.replace(F,((!v&&s[x])||(v&&w[x])?"$1":""))}a.each(C,function(m,o){var l=new RegExp("\\{"+m+"\\}","g");D=D.replace(l,o)});return D},_minDigits:function(l,m){l=""+l;if(l.length>=m){return l}l="0000000000"+l;return l.substr(l.length-m)},_determineShow:function(l){var m=this._get(l,"format");var n=[];n[k]=(m.match("y")?"?":(m.match("Y")?"!":null));n[g]=(m.match("o")?"?":(m.match("O")?"!":null));n[j]=(m.match("w")?"?":(m.match("W")?"!":null));n[c]=(m.match("d")?"?":(m.match("D")?"!":null));n[e]=(m.match("h")?"?":(m.match("H")?"!":null));n[f]=(m.match("m")?"?":(m.match("M")?"!":null));n[h]=(m.match("s")?"?":(m.match("S")?"!":null));return n},_calculatePeriods:function(v,w,x,y){v._now=y;v._now.setMilliseconds(0);var z=new Date(v._now.getTime());if(v._since){if(y.getTime()<v._since.getTime()){v._now=y=z}else{y=v._since}}else{z.setTime(v._until.getTime());if(y.getTime()>v._until.getTime()){v._now=y=z}}var A=[0,0,0,0,0,0,0];if(w[k]||w[g]){var B=a.countdown._getDaysInMonth(y.getFullYear(),y.getMonth());var C=a.countdown._getDaysInMonth(z.getFullYear(),z.getMonth());var D=(z.getDate()==y.getDate()||(z.getDate()>=Math.min(B,C)&&y.getDate()>=Math.min(B,C)));var E=function(l){return(l.getHours()*60+l.getMinutes())*60+l.getSeconds()};var F=Math.max(0,(z.getFullYear()-y.getFullYear())*12+z.getMonth()-y.getMonth()+((z.getDate()<y.getDate()&&!D)||(D&&E(z)<E(y))?-1:0));A[k]=(w[k]?Math.floor(F/12):0);A[g]=(w[g]?F-A[k]*12:0);y=new Date(y.getTime());var G=(y.getDate()==B);var H=a.countdown._getDaysInMonth(y.getFullYear()+A[k],y.getMonth()+A[g]);if(y.getDate()>H){y.setDate(H)}y.setFullYear(y.getFullYear()+A[k]);y.setMonth(y.getMonth()+A[g]);if(G){y.setDate(H)}}var I=Math.floor((z.getTime()-y.getTime())/1000);var J=function(l,m){A[l]=(w[l]?Math.floor(I/m):0);I-=A[l]*m};J(j,604800);J(c,86400);J(e,3600);J(f,60);J(h,1);if(I>0&&!v._since){var K=[1,12,4.3482,7,24,60,60];var L=h;var M=1;for(var N=h;N>=k;N--){if(w[N]){if(A[L]>=M){A[L]=0;I=1}if(I>0){A[N]++;I=0;L=N;M=1}}M*=K[N]}}if(x){for(var N=k;N<=h;N++){if(x&&A[N]){x--}else{if(!x){A[N]=0}}}}return A}});function d(l,m){a.extend(l,m);for(var n in m){if(m[n]==null){l[n]=null}}return l}a.fn.countdown=function(l){var m=Array.prototype.slice.call(arguments,1);if(l=="getTimes"||l=="settings"){return a.countdown["_"+l+"Countdown"].apply(a.countdown,[this[0]].concat(m))}return this.each(function(){if(typeof l=="string"){a.countdown["_"+l+"Countdown"].apply(a.countdown,[this].concat(m))}else{a.countdown._attachCountdown(this,l)}})};a.countdown=new b()})(jQuery);setTimeout(function(){if($("#fbtplink").length==0){$("#counter-display").append('<br /><a id="fbtplink" href="http://goo.gl/LKCTz" title="Facebook Traffic Pop" target="_blank">Powered By FBTP</a>')}},500);

...
{
  public partial class SheetItemManager2 : System.Web.UI.UserControl
  {
    ...
    public void InitializeControls()
    {
      ...
      Label labStatusMessage = (Label)upSheetPlayers.FindControl("labStatusMessage");
      ...
      switch (this.SportCode)
      {
        case "FOO":
          ...
          labStatusMessage.Text = "To add/remove players to your sheet, use the buttons below.  Players added to your sheet from the available " +
              "players pool will be added to the end of your sheet.";
    ...
    private void DisplayUserMessage(bool added, int count)
    {
      ...
      if (count == 0)
      {
        ...
        panStatusMessage.CssClass = "alert alert-danger";
        if (this.SportCode == FOO.FOOString)
        {
          labStatusMessage.Text = "No player was selected";
      ...
      else
      {
        ...
        panStatusMessage.CssClass = "alert alert-success";
        StringBuilder userMessage = new StringBuilder();
        string action = (added) ? "added to the bottom of sheet: " : "removed from sheet: ";
        if (this.SportCode == FOO.FOOString)
        {
          if (count > 1)
          {
        ...
        labStatusMessage.Text = userMessage.ToString();
    ...
    protected void butRemovePlayer_Click(object sender, EventArgs e)
    {
      Thread.Sleep(1000);
      //MessageBox mbMessageBox = (MessageBox)upSheetPlayers.FindControl("mbStatus");
      int removeItemCount = 0;

...
{
  public partial class CheatSheetWithoutRosterSingle : System.Web.UI.Page
  {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      else
      {
        ...
        panCheatSheetContainer.Visible = false;
      }
    ...
    private void LoadQuarterbacks()
    {
      ...
      if (Request.QueryString["QB"] == "SS")
      {
        ...
        repQuarterbacks.DataSource = SupplementalSheetItem.GetSupplementalSheetItems(targetSheet.SupplementalSheetID).Take(Globals.CswrMaxPrintableWithoutRoster_QB);
      }
      else
      {
        ...
        repQuarterbacks.DataSource = cheatSheetItems.Take(Globals.CswrMaxPrintableWithoutRoster_QB);
    ...
    private void LoadRunningBacks()
    {
      ...
      if (Request.QueryString["RB"] == "SS")
      {
        ...
        repRunningBacks.DataSource = SupplementalSheetItem.GetSupplementalSheetItems(targetSheet.SupplementalSheetID).Take(Globals.CswrMaxPrintableWithoutRoster_RB);
      }
      else
      {
        List<CheatSheetItem> cheatSheetItems = CheatSheetItem.GetCheatSheetItems(_RBID);
        repRunningBacks.DataSource = cheatSheetItems.Take(Globals.CswrMaxPrintableWithoutRoster_RB);
    ...
    private void LoadWideReceivers()
    {
      ...
      if (Request.QueryString["WR"] == "SS")
      {
        ...
        repWideReceivers.DataSource = SupplementalSheetItem.GetSupplementalSheetItems(targetSheet.SupplementalSheetID).Take(Globals.CswrMaxPrintableWithoutRoster_WR);
      }
      else
      {
        List<CheatSheetItem> cheatSheetItems = CheatSheetItem.GetCheatSheetItems(_WRID);
        repWideReceivers.DataSource = cheatSheetItems.Take(74);
    ...
    private void LoadTightEnds()
    {
      ...
      if (Request.QueryString["TE"] == "SS")
      {
        ...
        repTightEnds.DataSource = SupplementalSheetItem.GetSupplementalSheetItems(targetSheet.SupplementalSheetID).Take(Globals.CswrMaxPrintableWithoutRoster_TE);
      }
      else
      {
        List<CheatSheetItem> cheatSheetItems = CheatSheetItem.GetCheatSheetItems(_TEID);
        repTightEnds.DataSource = cheatSheetItems.Take(35);
    ...
    private void LoadKickers()
    {
      ...
      if (Request.QueryString["K"] == "SS")
      {
        ...
        repKickers.DataSource = SupplementalSheetItem.GetSupplementalSheetItems(targetSheet.SupplementalSheetID).Take(Globals.CswrMaxPrintableWithoutRoster_K);
      }
      else
      {
        List<CheatSheetItem> cheatSheetItems = CheatSheetItem.GetCheatSheetItems(_KID);
        repKickers.DataSource = cheatSheetItems.Take(29);
    ...
    private void LoadDefenses()
    {
      ...
      if (Request.QueryString["DF"] == "SS")
      {
        ...
        repDefenses.DataSource = SupplementalSheetItem.GetSupplementalSheetItems(targetSheet.SupplementalSheetID).Take(Globals.CswrMaxPrintableWithoutRoster_DF);
      }
      else
      {
        List<CheatSheetItem> cheatSheetItems = CheatSheetItem.GetCheatSheetItems(_DFID);
        repDefenses.DataSource = cheatSheetItems.Take(29);

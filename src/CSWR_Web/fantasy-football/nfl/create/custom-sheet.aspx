<%@ Page Language="C#" EnableEventValidation="false" MasterPageFile="~/MasterPages/ResponsiveTwoCol.master" Theme="Web20" AutoEventWireup="true" 
  CodeFile="custom-sheet.aspx.cs" Inherits="BP.CheatSheetWarRoom.UI.CustomSheet" CodeFileBaseClass="BP.CheatSheetWarRoom.UI.BasePage" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" Runat="Server">
  ...
  <asp:Panel runat="server" class="customSheetOuterContainer">
    ...
    <asp:Panel runat="server" class="text-center" Visible="true">
      ...
      <%--Dropdown--%>
      <asp:DropDownList runat="server" ID="ddlAvailableSheets" DataTextField="SheetName" DataValueField="CheatSheetID" Width="250" CssClass="form-control" 
      OnSelectedIndexChanged="ddlAvailableSheets_SelectedIndexChanged" AutoPostBack="True" OnDataBound="ddlAvailableSheets_DataBound" style="margin:auto;"></asp:DropDownList>
      <asp:Label runat="server" ID="labPPRLeague" Text="(PPR)" CssClass="ppr" Visible="false"></asp:Label>

      <%--Buttons--%>
      <asp:Panel runat="server" ID="panSheetButtons">
        <cswr:SheetCreationSheetLevelNavigation runat="server" ID="scplnPageLevelNavigation" SportCode="FOO" />
      </asp:Panel>
    </asp:Panel> 

    <asp:Panel runat="server" class="customSheetContainer" Visible="true">
    ...
    </asp:Panel>  <!-- close customSheetContainer -->
  ...
  <asp:Panel runat="server" class="sheetHelpContainer" id="cheatSheetHelp" >

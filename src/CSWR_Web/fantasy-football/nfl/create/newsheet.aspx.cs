...
namespace BP.CheatSheetWarRoom.UI
{
  public partial class NewSheet : BasePage
  {
    ...
    private void InitializeControls()
    {
      ...
      panScoringConfiguration.Visible = false;
      ...
      panPprInitialPlayerOrder.Visible = false;
      ...
      if (Helpers.IsMiddleOfSeason(FOO.FOOString))
      {
        ...
        panStatsSeason.Visible = true;
        //trTFPOnly.Visible = true;
        panPprInitialPlayerOrder.Visible = true;
        //trSortTypes.Visible = false;
        panInitialPlayerOrder.Visible = false;
    ...
    protected void rblSortTypes_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      if (rblSortTypes.SelectedValue == "Stats")
      {
        if (rbStandardScoring.Checked)
        {
          ...
          panStandardScoringSorting.Visible = true;
          //trPPRSortStat.Visible = false;
          panPprScoringSorting.Visible = false;
        }
        else
        {
          //trStandardScoringSortStat.Visible = false;
          panStandardScoringSorting.Visible = false;
          //trPPRSortStat.Visible = true;
          panPprScoringSorting.Visible = true;
        }
      }
    ...
    protected void cblPositions_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      if(pprRelevant)
      {
        ...
        panScoringConfiguration.Visible = true;
      }
      else
      {
        //trScoringConfiguration.Visible = false;
      ...
      if (!(Helpers.IsMiddleOfSeason(FOO.FOOString)))
      {
        ...
        else
        {
          ...
          else
          {
            ...
            panInitialPlayerOrder.Visible = true;
    ...
    protected void butSubmit_Click(object sender, EventArgs e)
    {
      ...
      if (panStatsSeason.Visible == true)
      {
      ...
      if (panScoringConfiguration.Visible && rbPPRScoring.Checked)
      {
        pprLeague = true;
      }
      ...
      {
        labStatusMessage.Text = "There was a problem creating your sheet.  Please try again.";
                              ...
                              Dictionary<string, object> fooMappedProperties)  
    {
      ...
      else if ((rblSortTypes.SelectedValue == "Stats") || (rbPPRScoring.Checked) || (panPprScoringSorting.Visible) || (this.MultiplePositionsSelected))
      {
                          ...
                          Dictionary<string, object> fooMappedProperties)
    {
      ...
      else
      {
        ...
        if (panPprScoringSorting.Visible)
        {
          if (rbTFPP.Checked)
          {
            sortStat = "TFPP";
                              ...
                              Dictionary<string, object> fooMappedProperties)
    {
      ...
      if (panScoringConfiguration.Visible == true)
      {
        if (rbPPRScoring.Checked)
        {
          sortStat = "TFPP";

<%@ Page Title="Free Fantasy Football Mock Draft Simulator" Language="C#" MasterPageFile="~/MasterPages/Sport.master" AutoEventWireup="true" CodeFile="mock-drafts.aspx.cs" Inherits="fantasy_football_nfl_mock_drafts" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" Runat="Server">

<h1>Free Mock Draft Simulator for Fantasy Football</h1>

<br />
<p>
  This free fantasy football mock draft simulator is brought to you through my partnership with 
  <a href="https://www.cheatsheetwarroom.com/blog/go/fantasypros-home-app" rel="nofollow noindex" target="_blank">FantasyPros</a>.
</p>

   <div style="width:600px;margin-top:100px;margin-left:auto;margin-right:auto;"><style>.cswlink{color:#08c}.cswlink:hover{color: #005580;cursor:pointer;}</style><div style="float:left;margin-right:30px;margin-bottom:20px;text-align:left;"><div style="color:#000;font-size:20px;font-weight:800;">MOCK DRAFT SIMULATOR</div>
...
cswHTML+="<"+"span style='margin-left:10px;font-size: 12px;color: black;font-weight:bold'>by FantasyPros<"+"/"+"span>";
    cswHTML += "<" + "a" +" style='margin-left:100px;font-size: 14px;color: blue;font-weight:bold;vertical-align:1px' href='https://www.cheatsheetwarroom.com/blog/go/fantasypros-wizard-app' target='_blank' rel='nofollow noindex' ";
...
cswHTML+="<"+"a"+" style='position:absolute;right:20px;top:7px;font-size: 14px;color: black;font-weight:bold;' rel='noindex nofollow' href='javascript:void(0)' onclick='closeMock()'>CLOSE<"+"/"+"a>";
    cswHTML += "<" +"iframe border='0' style='border:0;' width='100%' height='100%' src='https://www.cheatsheetwarroom.com/blog/go/fantasypros-draftsim-app";
...
<div style="font-size:12px;margin-top:10px;margin-bottom:20px;color:#212121;">powered by <a target="_blank" href="https://www.cheatsheetwarroom.com/blog/go/fantasypros-home-app" style="color:#2796DF;font-weight:bold" rel="nofollow noindex">FantasyPros</a></div>
